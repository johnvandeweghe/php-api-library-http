...
//TODO: Allow easy passing of bodies for errors.
abstract class AbstractRoutingLayerController extends \PHPAPILibrary\Core\Network\AbstractRoutingLayerController
{
    /**
    ...
    {
        return new HttpResponse(new Response(404));
    }
}
